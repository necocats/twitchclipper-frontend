            ...
            <nav className="navbar">
                <div className="container-fluid">
                    <a className="navbar-brand text-white" href="#">
                        <img src={twitchClipperIconSrc} alt="" width="25" height="25" className={`icon ${isRotating ? 'rotating' : ''} d-inline-block align-text-top`}/>
                        Twitch Clipper
                    </a>
                    <div className="d-flex justify-content-center align-items-center">
                        <form>
                            ...
                            : 
                            <button className="gsi-material-button" type="button" onClick={() => {handleSignIn()}}>
